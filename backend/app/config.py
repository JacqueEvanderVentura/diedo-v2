...
class Settings(BaseSettings):
    ...
    local_bootstrap_backoffice_password: SecretStr | None = None
    ...
    mail_provider: Literal["resend"] = "resend"
    ...
    crm_discovery_timeout_seconds: int = Field(default=8, ge=1, le=30)
