...
export const CALENDAR_STATUSES = [
  { id: 'confirmada', name: 'CONFIRMADO' },
  { id: 'cumplida', name: 'CUMPLIDA' },
  { id: 'noshow', name: 'NO SHOW' },
  { id: 'cancelada', name: 'CANCELADO' },
]
...
export function createDemoAppointments() {
  return [
    ...
    demoAppointment({ id: 'apt-seed-2', date: shiftDate(0), time: '11:00', duration: 60, customerId: 'c3', customerName: 'Ana Cristina Vargas', customerPhone: '809-555-0202', serviceId: 'p11', serviceName: 'Facial hidratante', price: 2500, status: 'confirmada', notes: 'Primera visita', cabinaId: 'cab2', employeeId: 'emp-4', firstTime: true, branchId: 'charm-santiago' }),
    demoAppointment({ id: 'apt-seed-3', date: shiftDate(0), time: '15:00', duration: 45, customerId: 'c5', customerName: 'Carla Jiménez', serviceId: 'p8', serviceName: '1 Sesión rostro', price: 700, status: 'confirmada', cabinaId: 'cab3', employeeId: 'emp-9', branchId: 'charm-este' }),
    ...
    demoAppointment({ id: 'apt-seed-7', date: shiftDate(2), time: '13:30', duration: 30, customerId: 'c4', customerName: 'Luis Alberto Peña', serviceId: 'p12', serviceName: 'Depilación bigote', price: 500, status: 'confirmada', cabinaId: 'cab1', employeeId: 'emp-9', branchId: 'charm-este' }),
    demoAppointment({ id: 'apt-seed-8', date: shiftDate(-1), time: '11:00', duration: 60, customerId: 'c1', customerName: 'María Fernández', serviceId: 'p10', serviceName: 'Cuerpo completo - pago', price: 0, status: 'cumplida', completed: true, completedAt: new Date(shiftDate(-1) + 'T11:45:00').toISOString(), completionPunctuality: 'delayed', delayResponsibility: 'customer', completionNote: 'Llegó tarde', cabinaId: 'cab3', employeeId: 'emp-6', freeTrial: true }),
    demoAppointment({ id: 'apt-seed-9', date: shiftDate(-2), time: '10:00', duration: 30, customerId: 'c3', customerName: 'Ana Cristina Vargas', serviceId: 'p2', serviceName: '1 sesión axilas', price: 900, status: 'cumplida', completed: true, completedAt: new Date(shiftDate(-2) + 'T10:20:00').toISOString(), completionPunctuality: 'on_time', cabinaId: 'cab1', employeeId: 'emp-1' }),
    demoAppointment({ id: 'apt-seed-10', date: shiftDate(-3), time: '14:00', duration: 30, customerId: 'c5', customerName: 'Carla Jiménez', serviceId: 'p2', serviceName: '1 sesión axilas', price: 900, status: 'cumplida', completed: true, completedAt: new Date(shiftDate(-3) + 'T14:05:00').toISOString(), completionPunctuality: 'on_time', cabinaId: 'cab2', employeeId: 'emp-1' }),
  ]
}
