...
export default function CrmStubPage({ title, description }) {
  return (
    <div className="mx-auto flex w-full max-w-[1400px] flex-col items-center justify-center p-6 sm:p-8" data-testid="crm-stub">
      <EmptyState
        icon={Construction}
